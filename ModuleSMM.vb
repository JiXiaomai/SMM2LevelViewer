        ...
        For M = 0 To MapHdr.TrackCount - 1
            ...
            Select Case MapTrk(M).Type
                Case 0
                    ...
                    MapTrk(M).F0 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K1 + &H10000) \ &H80) Mod 2
                Case 1
                ...
                Case 3, 6, 7
                    ...
                    MapTrk(M).F1 = ((MapTrk(M).K1 + &H10000) \ &H80) Mod 2
                Case 8
                    MapTrk(M).F0 = ((MapTrk(M).K1 + &H10000) \ &H80) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    MapTrk(M).F2 = ((MapTrk(M).K0 + &H10000) \ &H8000) Mod 2
                    TrackNode(MapTrk(M).X, MapTrk(M).Y + 2) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y + 4) += 1
                Case 9
                    MapTrk(M).F0 = ((MapTrk(M).K1 + &H10000) \ &H40) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K1 + &H10000) \ &H2) Mod 2
                    MapTrk(M).F2 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    TrackNode(MapTrk(M).X, MapTrk(M).Y) += 1
                    TrackNode(MapTrk(M).X, MapTrk(M).Y + 4) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y + 2) += 1
                Case 10
                    MapTrk(M).F0 = 1 - ((MapTrk(M).K0 + &H10000) \ &H4000) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K1 + &H10000) \ &H40) Mod 2
                    MapTrk(M).F2 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    TrackNode(MapTrk(M).X, MapTrk(M).Y) += 1
                ...
                Case 11
                    MapTrk(M).F0 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K1 + &H10000) \ &H2) Mod 2
                    MapTrk(M).F2 = ((MapTrk(M).K1 + &H10000) \ &H40) Mod 2
                    TrackNode(MapTrk(M).X + 2, MapTrk(M).Y) += 1
                    TrackNode(MapTrk(M).X, MapTrk(M).Y + 4) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y + 4) += 1
                Case 12
                    MapTrk(M).F0 = ((MapTrk(M).K1 + &H10000) \ &H800) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    MapTrk(M).F2 = ((MapTrk(M).K0 + &H10000) \ &H1000) Mod 2
                    TrackNode(MapTrk(M).X, MapTrk(M).Y + 2) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y + 4) += 1
                Case 13
                    MapTrk(M).F0 = ((MapTrk(M).K1 + &H10000) \ &H800) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K0 + &H10000) \ &H1000) Mod 2
                    MapTrk(M).F2 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    TrackNode(MapTrk(M).X, MapTrk(M).Y) += 1
                    TrackNode(MapTrk(M).X, MapTrk(M).Y + 4) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y + 2) += 1
                Case 14
                    MapTrk(M).F0 = ((MapTrk(M).K0 + &H10000) \ &H1000) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K1 + &H10000) \ &H800) Mod 2
                    MapTrk(M).F2 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    TrackNode(MapTrk(M).X, MapTrk(M).Y) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y) += 1
                    TrackNode(MapTrk(M).X + 2, MapTrk(M).Y + 4) += 1
                Case 15
                    MapTrk(M).F0 = ((MapTrk(M).K0 + &H10000) \ &H80) Mod 2
                    MapTrk(M).F1 = ((MapTrk(M).K0 + &H10000) \ &H1000) Mod 2
                    MapTrk(M).F2 = ((MapTrk(M).K1 + &H10000) \ &H800) Mod 2
                    TrackNode(MapTrk(M).X + 2, MapTrk(M).Y) += 1
                    TrackNode(MapTrk(M).X, MapTrk(M).Y + 4) += 1
                    TrackNode(MapTrk(M).X + 4, MapTrk(M).Y + 4) += 1
            End Select
